...
export default function SmartGrocery() {
  ...
  return (
    <div className="min-h-screen antialiased" style={{ background: "linear-gradient(180deg,#fffafc,#fffefe)" }}>
      {/* HEADER */}
      <header className="sticky top-2 z-40 bg-white/90 backdrop-blur-sm border-b" style={{ borderColor: "#f0f0f0" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              <div className="rounded-md p-1" style={{ background: "#fff0f4" }}>
                <img src="Logo.webp" alt="Smart Grocery Store Logo" width="76" height="76"/>
              </div>
              <div>
                <div className="font-extrabold text-lg lg:text-xl" style={{ color: BLUE }}>Smart Grocery Store</div>
                <div className="text-sm lg:text-xl text-gray-500">Smarter • Faster • Easier Way to Shop</div>
              </div>
            </div>
      ...
      {/* CATEGORIES & PRODUCTS */}
      <main className="max-w-7xl mx-auto px-2  sm:px-6 sm:mx-10 lg:px-8 mt-10 pb-15">
